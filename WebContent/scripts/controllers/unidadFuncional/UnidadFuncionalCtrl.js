 ...
 */
var UnidadFuncionalCtrl = function($scope, $rootScope, $routeParams, $filter, UnidadFuncionalService) {
	...
	$scope.crear = function() {
		...
		UnidadFuncionalService.crear($scope.elemento, function(resp) {
			$scope.mensajes = {
	...
	$scope.modificar = function() {
		...
		UnidadFuncionalService.modificar($scope.elemento, function(resp) {
			$rootScope.manageSaveCallback($scope, resp);
	...
	$scope.eliminar = function() {
		UnidadFuncionalService.eliminar($scope.borrando, function(resp) {
	...
	UnidadFuncionalService.listar("", function(response) {
