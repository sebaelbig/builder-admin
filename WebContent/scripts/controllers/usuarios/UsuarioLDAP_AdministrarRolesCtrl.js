 ...
 */
var UsuarioLDAP_AdministrarRolesCtrl = function($scope, $rootScope, $routeParams, UsuarioLDAPService, TipoDeRolService, RolService, TipoDeIDService) {
	...
	$scope.volver = function(){
		UsuarioLDAPService.username = null;
...
//		$scope.usuario = {roles: []};
	...
	$scope.inicializarElemento = function(){
		...
		$scope.haciendo = true;
		UsuarioLDAPService.getUsuarioRolesPorUsername(
			function(resp) {
