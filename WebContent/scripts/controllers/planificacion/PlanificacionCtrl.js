 ...
 * Panificacion Ctrl
 */
var PanificacionCtrl = function($scope, $rootScope, $routeParams, $filter, PlanificacionService) {
	...
	$scope.crear = function() {
		...
		PlanificacionService.crear($scope.elemento, function(resp) {
			$scope.mensajes = {
	...
	$scope.modificar = function() {
		...
		PlanificacionService.modificar($scope.elemento, function(resp) {
			$rootScope.manageSaveCallback($scope, resp);
	...
	$scope.eliminar = function() {
		PlanificacionService.eliminar($scope.borrando, function(resp) {
	...
	PlanificacionService.listar("", function(response) {
