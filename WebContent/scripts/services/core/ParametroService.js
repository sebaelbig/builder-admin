...
server.factory('ParametroService', function(HorusService) {
	
	var URL = "/core/parametros/seguro";
	...
	return {
		...
		listarTipos: function (successFn, errorFn) {
			return HorusService.authGet(URL+"/listarTipos", successFn, errorFn);
		},
